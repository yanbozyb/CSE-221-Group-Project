...
\begin{table*}[t]
	...
	\begin{tabular}{c|c|c|c|c|c|c}
		...
		\multirow{4}{*}{\makecell{CPU, \\ Scheduling, \\ OS}} & Procedure call & - & 1.7ns & <1$\mu$s  & \makecell{1ns \\ $\approx$3ns \\ for 7 args} & \makecell{1ns (0-6 args) \\ 3ns (7 args)} \\ \cline{2-7}

          & System call & - & <1$\mu$s & 1$\mu$s & 1$\mu$s & \makecell{0.55$\mu$s \\ 24ns (vDSO)} \\ \cline{2-7}
